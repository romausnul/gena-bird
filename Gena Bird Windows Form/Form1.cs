...
namespace Flappy_Bird_Windows_Form
{
    public partial class Form1 : Form
    {
        ...
        private void endGame()
        {
            ...
            scoreText.Text += "     гЕНА УМЕР!!"; // show the game over text on the score text, += is used to add the new string of text next to the score instead of overriding it
        }
        ...
        private void gameTimerEvent(object sender, EventArgs e)
        {
            ...
            scoreText.Text = "ОЧКО: " + score; // show the current score on the score text label
